...
flowchart TD
    subgraph "Phase 1: Foundations"
        A[Beginner Foundations<br/>Why Sovereignty + Basic Setup] 
    end

    subgraph "Phase 2: Building Agents"
        B[Max Security Agent Guide<br/>Plan Mode, Worktrees, Iterative Building]
    end

    subgraph "Phase 3: Hardening Tools"
        C[Advanced Production MCP<br/>Zero Trust, Authenticated Servers, Git Ops]
    end

    subgraph "Phase 4: Model Selection"
        D[Sovereign Local Models Guide<br/>Starter to Advanced Tiers + Grok Comparisons]
    end

    subgraph "Phase 5: Grok-Native Journey"
        E[Grok_Native_Sovereign_Agent_Path<br/>Start Grok-Native + Hybrid Points + Xplorer]
    end
    ...
    classDef default fill:#f5f5f5,stroke:#424242,stroke-width:2px
```
