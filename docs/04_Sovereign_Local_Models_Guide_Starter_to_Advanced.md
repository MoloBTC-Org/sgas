...
Choose the smallest model that can do the job. Use Grok as a lever on weak hardware. Move to larger local models only when the work or the sensitivity of the data requires it.

Read this guide after the foundations, agent, and MCP documents.
